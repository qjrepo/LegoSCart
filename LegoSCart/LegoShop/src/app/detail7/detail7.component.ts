...
export class Detail7Component implements OnInit {
  ...
  public item7: Lego;
  public static count17 : number = 0  ;
 ...
 add(i: number){
  this.checkout1=new Checkout(this.useremail,this.item7,1);
  alert("add successful");
  this.itemService.callserver(this.checkout1)
  .subscribe(data=> console.log("worked" + data + this.item7)),
