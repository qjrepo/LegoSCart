...
export class Detail6Component implements OnInit {
  ...
  public item6: Lego;
  public static count16 : number = 0  ;
 ...
 add(i: number){
  this.checkout1=new Checkout(this.useremail,this.item6,1);
  alert("add successful");
  this.itemService.callserver(this.checkout1)
  .subscribe(data=> console.log("worked" + data + this.item6)),
